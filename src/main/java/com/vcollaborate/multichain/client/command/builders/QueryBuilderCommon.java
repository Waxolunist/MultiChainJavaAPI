...
import com.vcollaborate.multichain.client.object.MultiChainRPCAnswer;
import com.vcollaborate.multichain.client.object.formatters.GsonFormatters;
...
abstract class QueryBuilderCommon extends GsonFormatters {
	...
	private Object executeRequest() throws IOException, ClientProtocolException, MultichainException {
		...
		if (multiChainRPCAnswer != null && multiChainRPCAnswer.getError() == null) {
			...
			throw new MultichainException(multiChainRPCAnswer.getError().get("code").toString(),
					multiChainRPCAnswer.getError().get("message").toString());
		} else {
