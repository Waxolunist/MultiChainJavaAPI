...
import com.vcollaborate.multichain.client.command.builders.QueryBuilderWalletTransaction;
import com.vcollaborate.multichain.client.object.BalanceAssetBase;
import com.vcollaborate.multichain.client.object.Transaction;
import com.vcollaborate.multichain.client.object.TransactionWallet;
import com.vcollaborate.multichain.client.object.TransactionWalletDetailed;
import com.vcollaborate.multichain.client.object.TxOut;
import com.vcollaborate.multichain.client.object.formatters.TransactionFormatter;
import com.vcollaborate.multichain.client.object.formatters.TxOutFormatter;
import com.vcollaborate.multichain.client.object.formatters.WalletTransactionFormatter;
...
public class WalletTransactionCommand extends QueryBuilderWalletTransaction {
	...
	/**
	 * {@link #getWalletTransaction(String, boolean, boolean) with watchOnly false and verbose true}
	 * 
	 * @param txid
	 * @return
	 * @throws MultichainException
	...
	/**
	 * {@link #getWalletTransaction(String, boolean, boolean) with watchOnly false and verbose false}
	 * 
	 * @param txid
	 * @return
	 * @throws MultichainException
	...
	/**
	 * {@link #listAddressTransactions(String, long, long, boolean) with verbose at false}
	 * 
	 * @param address
	 * @param count
	 * @param skip
	 ...
	 * @throws MultichainException
	 */
	public List<TransactionWallet> listAddressTransactions(String address, long count, long skip)
			throws MultichainException {
	...
	/**
	 * {@link #listWalletTransaction(long, long, boolean, boolean) with verbose at false}
	 * 
	 * @param count
	 * @param skip
	 * @param includeWatchonly
	...
	public List<TransactionWallet> listWalletTransaction(long count, long skip, boolean includeWatchonly)
			throws MultichainException {
		return listWalletTransaction(count, skip, includeWatchonly, false);
	}

	/**
	 * {@link #listWalletTransaction(long, long, boolean) with includeWatchonly at false}
	 * 
	 * @param count
	 * @param skip
	 * @return
	...
	public List<TransactionWallet> listWalletTransaction(long count, long skip) throws MultichainException {
		return listWalletTransaction(count, skip, false, false);
	}
	...
	public List<TransactionWallet> listWalletTransaction(long count) throws MultichainException {
		return listWalletTransaction(count, 0, false, false);
	}
	...
	public List<TransactionWallet> listWalletTransaction() throws MultichainException {
		return listWalletTransaction(10, 0, false, false);
	}
