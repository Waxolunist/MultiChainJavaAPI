...
import com.vcollaborate.multichain.client.command.builders.QueryBuilderStream;
import com.vcollaborate.multichain.client.object.Address;
import com.vcollaborate.multichain.client.object.Stream;
import com.vcollaborate.multichain.client.object.StreamKey;
import com.vcollaborate.multichain.client.object.StreamKeyItem;
import com.vcollaborate.multichain.client.object.formatters.StreamFormatter;
...
public class StreamCommand extends QueryBuilderStream {
	...
	public String getTxOutData(String txId, Double vout) throws MultichainException {
		return executeTxOutData(txId, vout);
	}
