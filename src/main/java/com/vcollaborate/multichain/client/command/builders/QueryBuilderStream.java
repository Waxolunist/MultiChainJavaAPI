...
public class QueryBuilderStream extends QueryBuilderCommon {
	...
	protected String executeTxOutData(String txId, Double vout) throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("txId", txId);
		MultichainTestParameter.isNotNull("vout", vout);
		
		return (String) execute(CommandEnum.GETTXOUTDATA, txId, vout.intValue());
	}
}